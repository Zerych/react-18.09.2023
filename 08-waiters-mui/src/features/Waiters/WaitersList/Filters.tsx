...
export function Filters() {
    ...
    return (
        <ButtonGroup size="small" variant="outlined" aria-label="outlined button group">
            ...
            <Button disabled={isActive(FILTER.A_M)} onClick={() => setFilter(FILTER.A_M)}>A-M</Button>
            <Button disabled={isActive(FILTER.N_Z)} onClick={() => setFilter(FILTER.N_Z)}>N-Z</Button>
            <Button disabled={isActive(FILTER.OTHER)} onClick={() => setFilter(FILTER.OTHER)}>Other</Button>
        </ButtonGroup>
    )
}